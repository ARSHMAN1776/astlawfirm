...
const timelineEras = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "AUST — Retained legal advisory services and service/employment matters",
      "HRSG (sourcing company based in Islamabad) — Retained legal matters related to Labour Courts and Peshawar High Court Abbottabad Bench",
